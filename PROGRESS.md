...
- GitHub Actions `release.yml` — auto-builds on git tag push:
  ...
  - `agentsentry-macos`
  - `agentsentry-linux`
- Fixed cp1252 Unicode encoding issue in build script (Windows runner compat)
- Users can download and run with zero Python installation
- Build confirmed working on GitHub Actions Windows runner (PyInstaller 6.20.0)
...
*Last updated: June 4, 2026 — v0.1.2 (exe build fixed)*
