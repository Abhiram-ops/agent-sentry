...
const NAV_LINKS = [
  ...
  { label: 'Docs',         href: 'https://github.com/Abhiram-ops/agent-sentry#readme', external: true },
  { label: 'Contact',      href: 'https://github.com/Abhiram-ops/agent-sentry/issues', external: true },
];
...
/* ── "Get Started Free" pill — Web3 layered design ──────── */
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="navbar-web3-hamburger"
          style={{
            background: 'none',
            border: 'none',
