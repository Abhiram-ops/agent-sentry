...
from agentsentry.core.models import (
    AutonomyLevel, CloudProvider, NonHumanIdentity,
    NHIType, Resource, ScanResult,
)
...
class MockScanner:
    ...
    def _build_nhis(self) -> list[NonHumanIdentity]:
        return [
            ...
            NonHumanIdentity(
                ...
                created_date=_dt(400), last_used=_dt(2), last_rotated=None,
            ...
            NonHumanIdentity(
                ...
                created_date=_dt(730), last_used=_dt(200), last_rotated=_dt(730),
            ...
            NonHumanIdentity(
                ...
                created_date=_dt(90), last_used=_dt(1), last_rotated=_dt(30),
                attached_policies=["AWSLambdaBasicExecutionRole", "s3:GetObject",
            ...
            NonHumanIdentity(
                ...
                created_date=_dt(180), last_used=_dt(1), last_rotated=_dt(180),
            ...
            NonHumanIdentity(
                ...
                provider=CloudProvider.AZURE,
                created_date=_dt(540), last_used=_dt(5), last_rotated=_dt(540),
            ...
            NonHumanIdentity(
                ...
                type=NHIType.SERVICE_PRINCIPAL,
                provider=CloudProvider.AZURE,
                created_date=_dt(800), last_used=_dt(300), last_rotated=_dt(800),
                attached_policies=["Storage Blob Data Contributor",
                                   "SQL DB Contributor"],
            ),
            ...
            NonHumanIdentity(
                ...
                created_date=_dt(300), last_used=_dt(1), last_rotated=_dt(300),
            ...
            NonHumanIdentity(
                ...
                provider=CloudProvider.GCP,
                created_date=_dt(400), last_used=_dt(10), last_rotated=_dt(400),
                attached_policies=["roles/bigquery.dataViewer", "roles/storage.objectViewer"],
            ...
            NonHumanIdentity(
                ...
                created_date=_dt(500), last_used=_dt(1), last_rotated=_dt(500),
            ...
            NonHumanIdentity(
                ...
                type=NHIType.GITHUB_SECRET,
                provider=CloudProvider.GITHUB,
                created_date=_dt(200), last_used=_dt(1), last_rotated=_dt(200),
            ...
            NonHumanIdentity(
                ...
                provider=CloudProvider.GITHUB,
                created_date=_dt(600), last_used=_dt(30), last_rotated=_dt(600),
            ...
            NonHumanIdentity(
                ...
                created_date=_dt(250), last_used=_dt(2), last_rotated=_dt(250),
            ...
            NonHumanIdentity(
                ...
                type=NHIType.SERVICE_ACCOUNT,
                provider=CloudProvider.K8S,
                created_date=_dt(180), last_used=_dt(1), last_rotated=_dt(90),
            ...
            NonHumanIdentity(
                ...
                provider=CloudProvider.LOCAL,
                created_date=_dt(60), last_used=_dt(0),
                autonomy_level=AutonomyLevel.FULLY_AUTONOMOUS,
                agent_tools=["query_database", "send_email",
                             "update_database", "delete_record", "call_api"],
                has_memory=True,
            ...
            NonHumanIdentity(
                ...
                type=NHIType.AI_AGENT,
                provider=CloudProvider.LOCAL,
                created_date=_dt(30), last_used=_dt(1),
    ...
    def _build_resources(self) -> list[Resource]:
        return [
            Resource(id="res-customer-db",   name="prod-customer-database",
                     resource_type="rds_instance",   provider=CloudProvider.AWS,
                     is_crown_jewel=True, sensitivity_tags=["PII", "PCI"]),
            Resource(id="res-model-weights", name="ml-model-weights-bucket",
                     resource_type="s3_bucket",       provider=CloudProvider.AWS,
                     is_crown_jewel=True, sensitivity_tags=["IP", "ML"]),
            Resource(id="res-secrets-mgr",   name="prod-secrets-manager",
                     resource_type="secretsmanager",  provider=CloudProvider.AWS,
                     is_crown_jewel=True, sensitivity_tags=["SECRETS"]),
            Resource(id="res-keyvault",      name="azure-prod-keyvault",
                     resource_type="key_vault",        provider=CloudProvider.AZURE,
                     is_crown_jewel=True, sensitivity_tags=["SECRETS"]),
            Resource(id="res-bq-dataset",    name="gcp-analytics-dataset",
                     resource_type="bigquery_dataset", provider=CloudProvider.GCP,
                     is_crown_jewel=True, sensitivity_tags=["PII"]),
            Resource(id="res-prod-cluster",  name="prod-k8s-cluster",
                     resource_type="k8s_cluster",      provider=CloudProvider.K8S,
                     is_crown_jewel=True, sensitivity_tags=["INFRA"]),
        ]
