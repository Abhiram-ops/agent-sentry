...
// Mobile / low-end devices: skip the WebGL scene entirely (saves GPU/battery
// and avoids frame-rate throttling) and fall back to a static gradient.
    ...
    return (
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(135deg, #04040e 0%, #001a0d 45%, #04040e 100%)',
        }}
      />
    );
  }
