            ...
            <div style={{ padding:"48px 48px 40px" }}>
              <div style={{ display:"flex", alignItems:"flex-start", gap:20, marginBottom:40, flexWrap:"wrap" }}>
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  ...
                  <p style={{ color:"#777777", fontSize:13, fontFamily:"monospace" }}>Abhiram Lanka · 2026</p>
                </div>
              </div>
                ...
                {HIGHLIGHTS.map((h, i) => {
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <div style={{ color:"#999999", fontSize:13, lineHeight:1.65 }}>{h.text}</div>
                    </div>
                  );
                })}
              </div>
              ...
              <div style={{
                ...
                <div style={{ color:"#999", fontSize:15, letterSpacing:"0.06em" }}>
                ...
                <div style={{ fontSize:12, color:"#777777", marginTop:8, lineHeight:1.8 }}>
              ...
              <div style={{ display:"flex", gap:14, flexWrap:"wrap" }}>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:8,
                  ...
                  color:"#666666", fontSize:14, borderRadius:10, fontFamily:"monospace" }}>
