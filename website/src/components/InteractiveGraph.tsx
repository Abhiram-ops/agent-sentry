                    ...
                    <div>
                      ...
                      <div style={{ display:"flex", flexWrap:"wrap", gap:5 }}>
                        {selected.mitre.map(t => (
                          <span key={t} style={{ padding:"2px 8px", borderRadius:4, fontSize:10, fontFamily:"monospace", background:"rgba(255,255,255,0.04)", color:"#555", border:"1px solid rgba(255,255,255,0.06)" }}>{t}</span>
                        ))}
                      </div>
                    </div>
                  )}
