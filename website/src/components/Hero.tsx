...
const LINES = [
  { text: "$ agentsentry scan aws --enrich",                               color: "#00ff88", delay: 0    },
  { text: "[•] Connecting to AWS…",                                        color: "#444",    delay: 600  },
  { text: "[•] Scanning IAM roles and access keys…",                       color: "#444",    delay: 1000 },
  { text: "[•] Fetching CISA KEV catalog (1,610 entries)…",                color: "#444",    delay: 1500 },
  { text: "[✓] 325 KEV entries linked to active ransomware campaigns",     color: "#555",    delay: 2000 },
  { text: "",                                                               color: "",        delay: 2200 },
  { text: "  NHIs Found: 47   Critical: 8   High: 12   AI Agents: 6",     color: "#fff",    delay: 2400 },
  { text: "",                                                               color: "",        delay: 2600 },
  { text: "● CRITICAL  ml-pipeline-executor    Score 450.0  AdminAccess",  color: "#ff3366", delay: 2800 },
  { text: "● CRITICAL  langchain-crm-agent     Score 300.0  Irreversible", color: "#ff3366", delay: 3100 },
  { text: "● CRITICAL  github-actions-deploy   Score 112.5  Internet+",    color: "#ff3366", delay: 3400 },
  { text: "● HIGH      legacy-reporting-key    Score  67.5  Unrotated",    color: "#ffcc00", delay: 3700 },
  { text: "",                                                               color: "",        delay: 4000 },
  { text: "⚠ CVE-2022-22954  VMware  ransomware active",                   color: "#ff3366", delay: 4200 },
  { text: "⚠ CVE-2021-42287  AD      priv-esc in wild",                    color: "#ff3366", delay: 4500 },
  { text: "",                                                               color: "",        delay: 4700 },
  { text: "[✓] Report saved → agentsentry-report-2026.json",              color: "#00ff88", delay: 4900 },
];
