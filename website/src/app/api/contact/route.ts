...
<p style="white-space:pre-wrap;line-height:1.6">${message}</p>
    ...
    await transporter.sendMail({
      ...
      text: `Hey ${name},\n\nThanks for reaching out. We read every message and typically reply within 24–48 hours.\n\nFor bugs, open a GitHub issue: https://github.com/Abhiram-ops/agent-sentry/issues/new\n\n— AgentSentry`,
...
<p style="color:#555;line-height:1.7">Thanks for reaching out. We read every message and typically reply within 24–48 hours. For bugs, feel free to also open a <a href="https://github.com/Abhiram-ops/agent-sentry/issues/new" style="color:#16a34a">GitHub issue</a>.</p>
<p style="color:#555">— AgentSentry<br/><span style="color:#999">support@agentsentry.org</span></p>
<p style="font-size:12px;color:#aaa;border-top:1px solid #eee;padding-top:16px;margin-top:24px">This is an automated confirmation. Your message was received at hello@agentsentry.org.</p>
</div>`,
    });
